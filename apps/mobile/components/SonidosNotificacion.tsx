    ...
    <View className="rounded-lg bg-secondary p-4">
      <View className="mb-4 flex-row items-center justify-between">
        <View className="flex-row items-center">
          ...
          <View className="ml-3">
            <Text className="text-lg font-semibold text-white">Sonidos de Notificación</Text>
      ...
      {soundEnabled && (
        <>
          <View className="mb-3 border-t border-gray-700 pt-3">
            <Text className="mb-3 text-sm font-medium text-gray-400">Probar sonidos:</Text>
          </View>
          ...
          <View className="space-y-2">
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-white">Éxito</Text>
              <Text className="text-xs text-gray-400">Tocar</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-white">Error</Text>
              <Text className="text-xs text-gray-400">Tocar</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-white">Advertencia</Text>
              <Text className="text-xs text-gray-400">Tocar</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-white">Información</Text>
              <Text className="text-xs text-gray-400">Tocar</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-white">Notificación</Text>
              <Text className="text-xs text-gray-400">Tocar</Text>
            </TouchableOpacity>
          </View>
        </>
