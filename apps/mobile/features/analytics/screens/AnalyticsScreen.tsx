    ...
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: '#090A0D' }}>
      ...
      >
        ...
        <View className="bg-[#13161E] rounded-[12px] p-4 mb-4">
          ...
          <LineChart
            data={[
              { label: t('dayMon'), value: 45, color: '#4ECDC4' },
              { label: t('dayTue'), value: 52, color: '#4ECDC4' },
              { label: t('dayWed'), value: 38, color: '#4ECDC4' },
              { label: t('dayThu'), value: 67, color: '#4ECDC4' },
              { label: t('dayFri'), value: 71, color: '#4ECDC4' },
              { label: t('daySat'), value: 29, color: '#4ECDC4' },
              { label: t('daySun'), value: 23, color: '#4ECDC4' }
            ]}
        ...
        <View className="bg-[#13161E] rounded-[12px] p-4 mb-4">
          ...
          <View className="bg-[#1D212D] rounded-lg p-4 mb-3">
            ...
            <Text className="text-gray-400 mb-3">892 {t('analyticsUsersLast24h')}</Text>
          ...
          <View className="bg-[#1D212D] rounded-lg p-4 mb-3">
            ...
            <Text className="text-gray-400 mb-3">156 {t('analyticsReportsThisWeek')}</Text>
          ...
          <View className="bg-[#1D212D] rounded-lg p-4">
            <View className="flex-row justify-between items-center mb-2">
              <Text className="text-white font-bold">{t('analyticsEngagementRate')}</Text>
              <View className="bg-purple-500 px-3 py-1 rounded-full">
                <Text className="text-white text-xs">+22%</Text>
              </View>
            </View>
            <Text className="text-gray-400 mb-3">87% {t('analyticsAvgEngagement')}</Text>
