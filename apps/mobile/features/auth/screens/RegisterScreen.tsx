        ...
        <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: '#0f172a' }}>
            ...
            <KeyboardAvoidingView
                ...
                <ScrollView
                    ...
                    <View className="mb-20 w-full px-6">
                        ...
                        <View className="mb-8 items-center">
                            ...
                            <View className="mb-8 w-72 space-y-2">
                                ...
                                <TextInput
                                    ...
                                    value={username}
                                    onChangeText={(v) =>
                                        handleFieldChange('username', v, setUsername)
                                    }
                                    style={{
                                        borderColor: fieldErrors.username ? 'red' : 'white',
                                        borderBottomWidth: 1,
                                        color: 'white',
                                        paddingBottom: 8,
                                        fontSize: 18,
                            ...
                            <View className="mb-8 w-72 space-y-2">
                                ...
                                <TextInput
                                    ...
                                    value={password}
                                    onChangeText={(v) =>
                                        handleFieldChange('password', v, setPassword)
                                    }
                                    style={{
                                        borderColor: fieldErrors.password ? 'red' : 'white',
                                        borderBottomWidth: 1,
                                        color: 'white',
                                        paddingBottom: 8,
                                        fontSize: 18,
                                ...
                                <TextInput
                                    ...
                                    style={{
                                        borderColor: fieldErrors.confirmPassword ? 'red' : 'white',
                                        borderBottomWidth: 1,
                                        color: 'white',
                                        paddingBottom: 8,
                                        fontSize: 18,
                            ...
                            <View className="mb-8 w-72 space-y-2">
                                ...
                                <View className="flex-row items-center">
                                    ...
                                    <TextInput
                                        ...
                                        className="flex-1 border-b border-white pb-2 text-xl text-white"
                                        maxLength={8}
                                        value={phone}
                                        onChangeText={(v) => {
                                        ...
                                        style={{
                                            borderColor: fieldErrors.phone ? 'red' : 'white',
                                            borderBottomWidth: 1,
                                            color: 'white',
                                            paddingBottom: 8,
                                            fontSize: 18,
